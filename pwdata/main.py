...
def run_scale_cell(cmd_list:list[str]):
    ...
    parser.add_argument('-f', '--input_format',  type=str, required=False, default=None, help="The input file format, the supported format as ['pwmat/config','vasp/poscar', 'lammps/lmp', 'cp2k/scf', 'castep/scf']")
...
def run_convert_config(cmd_list:list[str]):
    ...
    parser.add_argument('-i', '--input',         type=str, required=True, help='The input file path')
    parser.add_argument('-f', '--input_format',  type=str, required=False, default=None, help="The input file format, if not specified, the format will be automatically inferred based on the input file. the supported format as ['pwmat/config','vasp/poscar', 'lammps/lmp', 'cp2k/scf', 'castep/scf']")
    parser.add_argument('-s', '--savename',      type=str, required=False, default=None, help="The output file name, if not provided, the 'atom.config' for pwmat/config, 'POSCAR' for vasp/poscar, 'lammps.lmp' for lammps/lmp will be used")
